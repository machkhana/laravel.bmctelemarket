...
class ClientRequest extends FormRequest
{
    ...
    public function rules()
    {
        switch ($this->method()) {
            ...
            default: {
                return [
                    'user_id' => 'required|int:clients,user_id,',
                    ...
                    'address' => 'required|string:clients,address',
                    'interes' => 'nullable|string:clients,interes',
                    'work_place' => 'nullable|string:clients,work_place',
